<template>
  ...
  >
    ...
    <view
      class="u-drawer-content rounded-t-lg"
    ...
    >
      ...
      >
        <div
          class="u-close iconfont iconclose-bold"
      ...
      <scroll-view
        class="u-drawer__scroll-view px-4 py-3"
        scroll-y="true"
        v-else
      >
        <slot />
      ...
      <view @tap="close" class="u-close iconfont iconclose-bold" :class="['u-close--' + closeIconPos]">
      </view>
    </view>
  </view>
</template>
...
export default {
  ...
  computed: {
    ...
    // 计算整理后的z-index值
    uZindex() {
      return this.value ? (this.zIndex ? this.zIndex : 10075) : -10075;
    },
  },
  watch: {
    value(val) {
