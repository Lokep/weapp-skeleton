...
export const ToastMiddleware = async (config: Partial<IRequestConfig>, next: Function) => {
...
export const DelayLoadingMiddleware = async (config: Partial<IRequestConfig>, next: Function) => {
...
export const ErrorHandlerMiddleware = async (config: Partial<IRequestConfig>, next: Function) => {
  console.log('[config]: ', config)
...
export const LogMiddleware = async (config: Partial<IRequestConfig>, next: Function) => {
 ...
 * @returns 
 */
export const AuthMiddleware = async (config: Partial<IRequestConfig>, next: Function) => {
...
export const ResponseMiddleware = async (config: Partial<IRequestConfig>, next: Function) => {
  console.log('[config]: ', config)
